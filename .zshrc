...
export suninfo="$(curl -s "http://weather.yahooapis.com/forecastrss?p=USNY0996&u=f"| grep astronomy | awk -F\" '{print $2;  print $4;}')"
export SUNRISE=${suninfo[1,7]}
export SUNSET=${suninfo[9,99]}
